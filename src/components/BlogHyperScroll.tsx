...
export function BlogHyperScroll({ blogs }: BlogHyperScrollProps) {
  ...
  return (
    <section
      ...
      className="mt-0 flex h-full min-h-48 flex-1 flex-col justify-center overflow-hidden"
    >

      <ol
        className="perspective-distant relative flex h-full min-h-48 flex-1 touch-none items-center justify-center overflow-hidden"
        tabIndex={0}
        onWheel={handleWheel}
