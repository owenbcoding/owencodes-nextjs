...
export function MainNavigation() {
  ...
  return (
    <nav className="fixed inset-x-0 top-0 z-50 bg-white/5 p-2 shadow-[inset_0_0_8px_rgba(255,255,255,0.1),0_0_15px_rgba(45,212,191,0.15)] backdrop-blur-xl">
      <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-4 sm:px-6">
            ...
            return (
              <li key={item.name}>
                <Link
                  ...
                  className={`rounded-full px-4 py-2 text-sm font-semibold transition-colors duration-200 hover:bg-white/10 hover:text-teal-400 ${
                    active
        ...
        <button
          type="button"
          className="inline-flex items-center justify-center rounded-full border transition-colors hover:bg-white/10 hover:text-white md:hidden"
